	...
	var ElementPack = {
		...
		init: function() {
			...
			var widgets = {
				...
				'testimonial-carousel-mode.default' 		   : ElementPack.widgetTCarousel,
				'testimonial-carousel-mode.bdt-twyla' 	   : ElementPack.widgetTCarousel,
				'testimonial-carousel-mode.bdt-vyxo' 	   : ElementPack.widgetTCarousel,
				'testimonial-slider-mode.default' 		   : ElementPack.widgetTSlider,
		...
		widgetTCarousel: function( $scope ) {
			...
			var $tCarousel = $scope.find( '.testimonial-carousel-mode' );
...
jQuery(document).ready(function () {
  ...
  var mySwiper = new Swiper ('.swiper-container-grid', {
    // Optional parameters
    ...
    // Navigation arrows
    navigation: {
      nextEl: '.bdt-navigation-next-grid',
      prevEl: '.bdt-navigation-prev-grid',
    },
